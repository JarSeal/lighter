...
export type TCMP<WrapP = TProps> = {
  ...
  remove: () => TCMP;
  removeChildren: () => TCMP;
  update: (newProps?: TProps | WrapP, callback?: (cmp: TCMP) => void) => TCMP;
...
export const CMP = <WrapP = TProps>(
  props?: TProps,
  wrapper?: ((props?: WrapP) => TCMP) | ((props: TProps | WrapP) => TCMP),
  wrapperProps?: unknown
): TCMP<WrapP> => {
  ...
  const cmp: TCMP = {
    ...
    update: (newProps?: TProps | WrapP, callback?: (cmp: TCMP) => void) =>
